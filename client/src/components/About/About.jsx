...
const About = () => {
    return(
        <div>
            ...
            <h3 className={styles.subtitle} align="center">Languages and tools used to develop this SPA</h3>
            <h4 className={styles.subtitle} align="center"> Javascript - Node.js - Express - PostgreSQL - Html - React - Redux - Css </h4>
